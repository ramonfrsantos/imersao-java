...
public class StickerGenerator {
  ...
  void createSticker(InputStream inputStream, String fileName, String subtitle) throws Exception {
    // leitura da imagem
    ...
    // configurar a fonte
    var font = new Font(Font.SANS_SERIF, Font.BOLD, 78);
    graphics.setColor(Color.YELLOW);
    graphics.setFont(font);

    // escrever uma frase na nova imagem
    graphics.drawString(subtitle, 100, newHeight - 50);
